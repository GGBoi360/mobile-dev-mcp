 ...
 *
 * For full automation capabilities, see CodeControl: https://codecontrol.dev
 *
        ...
        return {
          content: [{
            ...
            text: JSON.stringify({
              ...
              note: "These are SUGGESTIONS only. MobileDevMCP is read-only. For automation, see CodeControl: https://codecontrol.dev",
            }, null, 2),
          }],
        };
      } catch (error: any) {
...
async function main() {
  ...
  console.error(`License: ${license.tier.toUpperCase()} (${license.tier === "free" ? 12 : 21} tools)`);
